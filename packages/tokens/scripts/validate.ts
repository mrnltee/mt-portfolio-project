...
const CONTRAST: Array<[string, string, number, string]> = [
  ...
  ['color.action.on-primary', 'color.action.primary-hover', 4.5, 'on-primary / primary-hover'],
  ...
  ['color.action.on-accent-subtle', 'color.action.accent-subtle', 4.5, 'on-accent-subtle / accent-subtle'],
